...
function Navbar() {
    ...
    const { connect, disconnect, isActive, account, walletModal, handleWalletModal } = useMetaMask();
    useEffect(() => {
        ...
        <div>
            <nav className="navbar navbar-default navbar-trans navbar-expand-lg">
                <div className="container">
                    <a className="navbar-brand text-brand" to="/">
                        <img src="images/logo.png" alt="" />
                    </a>
                    <div className="navbar-collapse collapse justify-content-end" id="navbarDefault">
                        <ul className="navbar-nav">
                            <li className="nav-item">
                                <a className="nav-link" href="#" title="Trade"> Menu 1</a>
                            </li>
                            <li className="nav-item">
                                <a className="nav-link" href="" title="Earn"> Menu 2 </a>
                            </li>
                            <li className="nav-item">
                                <a className="nav-link" href="" title="Project"> Menu 3 </a>
                            </li>
                            <li className="nav-item">
                                <a className="nav-link" href="" title="Audit"> Menu 4 </a>
                            </li>
                            <li className="nav-item">
                                <a className="nav-link" href="" title="Analytics"> Menu 5 </a>
                            </li>
                            ...
                            <li>
                                {isActive ? (
                                    <a>
                                        ...
                                        <a type='button' className="sr-btn" onClick={() => { handleWalletModal(true); setModal(true) }} >Connect Wallet</a></>)}
                                    ...
                                    {modal ? (<div className="modal-dialog">
                                        <div className="modal-content">
                                            <div className="modal-header">
                                                ...
                                                <a type="button" class="close" data-dismiss="modal" onClick={() => setModal(false)}>
                                                    &times;
                                                </a>
                                            </div>
                                            <div className="modal-body">
                                                <a type="button" className="btn-connect" onClick={() => connect('metaMask', '0X4')}>
                                                    <h1 className="connect">metamask</h1>
                                                    <img src="images/meta.png" />
                                                </a>

                                                <a type="button" className="btn-connect" onClick={() => connect('walletConnect')}>
